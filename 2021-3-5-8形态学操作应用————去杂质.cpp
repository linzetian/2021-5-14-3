...
int main()
{
	...
	imshow("gray", dst);
	adaptiveThreshold(~dst,binImg,255,ADAPTIVE_THRESH_MEAN_C,THRESH_BINARY,17,-2);
	...
	morphologyEx(binImg, output1, MORPH_RECT, kernel, Point(-1, -1));
	Mat output2, output3;
